...
Game.prototype.distQueue = function distQueue () {
  ...
  this.players.forEach(function (player) {
    ...
    player.socket.emit('board:queue', player.board.queue)
  })
}
